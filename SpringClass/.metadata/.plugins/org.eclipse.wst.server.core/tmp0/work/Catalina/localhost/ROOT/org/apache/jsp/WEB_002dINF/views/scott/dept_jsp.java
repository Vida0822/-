 ...
 * Generated at: 2023-06-27 05:26:08 UTC
...
public final class dept_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("</style>\r\n");
      out.write("<style>\r\n");
      out.write("  tbody tr td:last-child  span:hover{\r\n");
      out.write("    color:red;\r\n");
      out.write("    cursor: pointer;\r\n");
      out.write("  }\r\n");
      out.write("  tbody tr:hover{ background-color: rgba(240,240,240,0.5); }\r\n");
      out.write("</style> \r\n");
      out.write("<style>\r\n");
      ...
      out.write("\r\n");
      out.write("<div class=\"message\" title=\"Spring MVC 처리과정\">\r\n");
      out.write("	<ul>\r\n");
      out.write("		<li> pom.xml - 스프링 5.0.7 </li>\r\n");
      out.write("	</ul>\r\n");
      out.write("</div>\r\n");
      out.write("<h3><span class=\"material-symbols-outlined\">lists</span> Dept Info</h3>\r\n");
      out.write("\r\n");
      ...
      out.write("			           <!-- form에서 button은 기본이 submit기능이라 type=\"button\"을 해주면 submit 안됨  -->\r\n");
      ...
      out.write("	    \r\n");
      out.write("	  $(\"#add\").on(\"click\", function() {      addModal.css(\"display\", \"block\");            } );\r\n");
      out.write("	  $(\".cancel\").on(\"click\", function() {      addModal.css(\"display\", \"none\");            } ); \r\n");
      out.write("	  $(\"body\").on(\"click\", function (event){\r\n");
      out.write("	     if( event.currentTarget == addModal ) addModal.css(\"display\", \"none\");  \r\n");
      out.write("	  });   // [ 부서 추가 ]\r\n");
      out.write("	  \r\n");
      out.write("	// 확인버튼 클릭  ajax 추가 + 테이블 추가\r\n");
      ...
      out.write("		    	 addModal.css(\"display\", \"none\") ; // 모달창 닫기 \r\n");
      out.write("				 if(result === 'SUCCESS'){ // db 작업 성공 (백앤드 작업은 끝, 이제 프론트에서 표시만 해주면 됨)\r\n");
      out.write("				 // 반복문으로 출력해주던걸 그냥 바로 tr,td 태그 수기로 추가 \r\n");
      out.write("					let tr = $(`\r\n");
      out.write("						<tr>\r\n");
      ...
      out.write("				 			// .on(\"click\", function(event) { // 이벤트를 '장착' 했다고 생각 \r\n");
      out.write("				 			.on(\"click\", function() { // 이벤트를 '장착' 했다고 생각 \r\n");
      out.write("				 				if (confirm(\"정말 삭제할까요?\")) {\r\n");
      out.write("				 					let deptno = $(this).data(\"deptno\"); // 삭제 클릭한 부서번호 가져와서 \r\n");
      ...
      out.write("				 							// $(event.currentTarget).parents(\"tr\").remove() ;  \r\n");
      out.write("				 					}) ;  // remove\r\n");
      out.write("				 				}// if \r\n");
      out.write("							});  // click \r\n");
      out.write("				 } // if \r\n");
      ...
      out.write("	   \r\n");
      out.write("	   // Edit - x버튼 \r\n");
      out.write("   $(\"#tbl-dept > tbody > tr > td > span\").on(\"click\", function() { // 로딩되어질 때 존재하는 객체들한테만 이벤트가 갈리기 때문에 새로 생성된 애들은 그 시점 이후라 이벤트가 적용되지 않는다\r\n");
      out.write("			if (confirm(\"정말 삭제할까요?\")) {\r\n");
      out.write("				let deptno = $(this).data(\"deptno\"); // 삭제 클릭한 부서번호 가져와서 \r\n");
      out.write("				deptService.remove(deptno, function(result) {\r\n");
      out.write("					if(result === 'SUCCESS') $(event.currentTarget).parents(\"tr\").remove() ;  //  프론트단에서 삭제 \r\n");
      out.write("				}) ;  // remove\r\n");
      out.write("			}// if \r\n");
      out.write("	}) ;  // 삭제 클릭 \r\n");
      out.write("	   \r\n");
  ...
  private boolean _jspx_meth_c_005fforEach_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/scott/dept.jsp(122,7) name = items type = javax.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
      _jspx_th_c_005fforEach_005f0.setItems(new org.apache.jasper.el.JspValueExpression("/WEB-INF/views/scott/dept.jsp(122,7) '${list}'",_jsp_getExpressionFactory().createValueExpression(_jspx_page_context.getELContext(),"${list}",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
      // /WEB-INF/views/scott/dept.jsp(122,7) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      try {
        ...
        if (_jspx_eval_c_005fforEach_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            out.write("\r\n");
            out.write("      		<tr>\r\n");
            out.write("      			<td><input type=\"checkbox\" data-deptno=\"");
            ...
            out.write("</td>\r\n");
            out.write("		        <td align=\"center\"><span class=\"material-symbols-outlined delete\" data-deptno=\"");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ dto.deptno }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
