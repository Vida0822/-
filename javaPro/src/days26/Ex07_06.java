...
public class Ex07_06 {
	...
	public static void main(String[] args) {
		...
		System.out.println(juice); // days26.Juice@782830e
...
// 과일/사과/포도 -> 과일박스를 매개변수로 쥬스 만들어서 반환하는 Juicer 클래스 선언
