...
/**
 * @author dlsgu
 * @date 2023. 2. 9. - 오후 2:36:23
 * @subject ***달력 만들기*** [시험문제3] 달력 코딩 전부
 * @content 
 *
 */
public class Ex04 {
	...
	private static void printCalendar(int year, int month) {
		...
		// (2)
		int dayOfWeek = getDayOfWeek(year, month,1); // 0(일)~6(토)
		System.out.printf("\t[%d년 %d월]\n", year, month);
		
		days08.Ex03_02.drawLine(55, '-');
		String week = "일월화수목금토";
	...
	private static int getLastDay(int year, int month) {
		int [] months = {31,28,31,30,31,30,31,31,30,31,30,31};
		if (month == 2) return days08.Ex04.isLeapYear(year) ? 29 : 28;
	...
	private static int getLastDay(int year, int month) {
		...
		case 1: case 3:case 5: case 7: case 8: case 10: case12:
			...
			break;
		case 2:
			lastDay = days08.Ex04.isLeapYear(year) ? 29 : 28;
			break;
		}
