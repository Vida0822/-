...
public class Ex09 {
	...
	public static void main(String[] args) {
		...
		// Shape s = new Shape();
		// s. -> 왜 9개의 메서드가 보일까 -> Object 클래스를 상속 받았다
		// 모든 클래스의 최상위 슈퍼클래스는 java.lang.Object 클래스이다
		// Object가 가지고 있는 메서드들에 대한 공부를 먼저 해야한다
		...
		c.color = "red";
		// Shape 부모클래스로부터 상속받은 draw() 메서드는 color 색만 출력
		// Shape 부모클래스로부터 상속받은 draw() 메서드를 수정(재정의)해서 사용하고 싶다
		// 원의 원점 출력 + 색깔 출력
...
// 도형 클래스
// 자바는 컴파일러가 Object 클래스를 상속받도록 처리한다
...
class Circle extends Shape { // is-a 관계
	...
	// @Override 재정의함수		Annotation(어노테이션)
	@Override
	void draw() {
...
class Triangle extends Shape {
	...
	// 삼각형을 그려주는 함수를 부모로부터 물려받아서 재정의한다 == 오버라이딩(override)
	@Override
	void draw() {
