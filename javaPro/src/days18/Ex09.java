...
public class Ex09 {
	...
	public static void main(String[] args) {
		 ...
		 * 	2) throws문
		 * 
		 * 	- 예외처리 정의 : 프로그램 실행 시 발생할 수 있는 예기치 못한 예외의 발생에 대비한 코드를 작성하는 것
		 *  - 예외처리 목적 : 프로그램의 비정상 종료를 막고, 정상적인 실행상태를 유지하기 위해
		 *  
		 *  5. 코딩 후 실행 (Ctrl + F11)을 하면 예외가 발생 -> 예외처리 X -> 출력 + 비정상적으로 종료
		 *  												-> 예외처리 (try~catch문) O
		 *  												JVM의 "예외처리기"가 발생한 예외(uncaught exception)을 받아서
		 *  												try~catch문에 예외객체를 전달해준다
		 * */
