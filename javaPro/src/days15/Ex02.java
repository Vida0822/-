...
public class Ex02 {
	...
	public static void main(String[] args) {
		...
		// The method offset(int) is undefined for the type MyPoint 선언되지 않은 함수
		p1.offsetPoint(5);
		p1.dispMyPoint(); // 5, 5
		...
		// offsetPoint() 메서드의 리턴타입이 MyPoint 클래스 타입이 아니기 때문에
