...
<head>
<meta charset="UTF-8">
<title>2023. 6. 1. - 오전 7:35:12</title>
		 ...
		 <tr class="data">
		   ...
		   <!--  답글이라면! (depth > 0)  -->
		    <c:if test="${ dto.depth  gt 0 }">
		       <img width="${ dto.depth*15 }px"> <!-- 들여쓰기지만 사실 이건 이미지였다!   -->
		       <img src="/jspPro/days13/replyboard/images/arr.gif"><!-- 화살표 이미지 -->
		    </c:if>
		     ...
		     <c:if test="${ dto.newImg }">
		        <img src="/jspPro/days13/replyboard/images/ico-new.gif" alt="1시간이 지나지 않은 게시글">
		     </c:if>
		   </td>
		   <td> 
		     <c:if test="${ dto.writer == '이창익' }">
		       <img src="/jspPro/days13/replyboard/images/star.gif">
		     </c:if>
