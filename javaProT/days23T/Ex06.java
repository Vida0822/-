...
public class Ex06 {
	...
	public static void main(String[] args) {
		...
		// 올해의 첫 날 : 2023-01-01
		System.out.println(   d.with(   TemporalAdjusters.firstDayOfYear() ) );
		// 내년의 첫날 : 2024-01-01
		System.out.println(   d.with(   TemporalAdjusters.firstDayOfNextYear() ) );
		
		// 이번 달의 첫 번째 월요일 ?  2023-02-06
		System.out.println(   d.with(   TemporalAdjusters.firstInMonth( DayOfWeek.MONDAY ) ) );
		// 이번 달 마지막 토요일 날 만나..( 약속 ) : 2023-02-25
		System.out.println(   d.with(   TemporalAdjusters.lastInMonth( DayOfWeek.SATURDAY ) ) );
		
		// 다음달의 금요일 휴강... : 2023-03-03
		System.out.println(   d.with(   TemporalAdjusters.next(DayOfWeek.FRIDAY) ) );
		
		// 이번 달의 3번째 토요일 만나 : 2023-02-18
		System.out.println(   d.with(   TemporalAdjusters.dayOfWeekInMonth(3, DayOfWeek.SATURDAY)  ) );
		
		// 지난 화요일 몇 일이니? 
		System.out.println(   d.with(   TemporalAdjusters.previous( DayOfWeek.SATURDAY)  ) ); // 오늘 포함X
		System.out.println(   d.with(   TemporalAdjusters.previousOrSame( DayOfWeek.SATURDAY)  ) );  // 오늘 포함
